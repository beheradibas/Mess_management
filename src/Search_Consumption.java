 ...
 */
public class Search_Consumption extends javax.swing.JFrame {

    /**
     * Creates new form Search_Consumption
     */
    public Search_Consumption() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DAILY CONSUMPTION FINDER");
        ...
        result.setToolTipText("ADJUST THE COLUMN SIZE TO SEE NAMES OF ITEMS");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(row>0){
            ...
            String query ="select * from consumption where date ='"+date+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Search_Consumption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Consumption().setVisible(true);
            }
        });
    }
